...
export const translations = {
  en: {
    ...
    calculator: {
      ...
      heroTitlePrefix: "Fiscal Residency",
      heroTitleSuffix: "Assessment.",
      heroSubtitle: "Calculate your fiscal residency status and generate a verified report in minutes.",
    ...
    onboarding: {
      welcomeTitle: "Fiscal Residency Assessment",
      welcomeDesc: "Evaluate your tax residency status in 4 simple steps.",
  ...
  es: {
    ...
    calculator: {
      ...
      heroTitlePrefix: "Evaluación de",
      heroTitleSuffix: "Residencia Fiscal.",
      heroSubtitle: "Calcula tu situación de residencia fiscal y descarga un informe verificado en minutos.",
      ...
      generateReport: "DESCARGAR INFORME",
    ...
    payment: {
      ...
      item: "Informe Fiscal Verificado",
      days: "Días Totales",
      total: "Total",
    ...
    onboarding: {
      welcomeTitle: "Evaluación de Residencia Fiscal",
      welcomeDesc: "Evalúa tu situación de residencia fiscal en 4 sencillos pasos.",
